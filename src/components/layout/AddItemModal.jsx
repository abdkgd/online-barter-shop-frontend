                    ...
                    <div className="container">
                            ...
                            <div className="row mb-2">
                                <div className="col-6">
                                    ...
                                    <select class="form-control" onChange={handleChange} id="category">
                            ...
                            <div className="row mb-2">
                                <div className="col-6">
                                    ...
                                    <select class="form-control" onChange={handleChange} id="status">
                                ...
                                <div className="col-6">
                                    ...
                                    <select class="form-control" onChange={handleChange} id="isTradeable">
                                        <option selected>Select Tradeable</option>
