    ...
    return (
        <div className="item-category-wrapper ml-3">
            <Card bg="light" style={{ width: '12rem' }} className="mb-2">
                ...
                <Card.Text>
                        <label><input type="radio" name="category" value="All" onClick={(e) => handleRadio(e.target.value)}/> All</label><br />
                        <label><input type="radio" name="category" value="Clothing" onClick={(e) => handleRadio(e.target.value)}/> Clothing</label><br />
                        <label><input type="radio" name="category" value="Furniture" onClick={(e) => handleRadio(e.target.value)}/> Furniture</label><br />
