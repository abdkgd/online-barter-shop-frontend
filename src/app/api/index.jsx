...
const messageURL = "http://localhost:7000/api/messages";
...
export const getMessages = () => axios.get(messageURL);
...
export const composeMessage = (message) => axios.post(messageURL, message);
export const updateCart = (cart) => axios.put(cartURL, cart);
export const updateMessage = (message) => axios.put(messageURL, message);
